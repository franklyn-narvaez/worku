...
export default function OfferCreateFormDependence() {
	...
	return (
		<div className="min-h-screen w-full overflow-y-auto flex justify-center gap-4 p-6">
			<FormProvider {...methods}>
				<form
					onSubmit={handleSubmit(onSubmit)}
					className="bg-white/95 p-10 rounded-2xl shadow-2xl w-full max-w-4xl flex-col items-center my-auto"
				>
