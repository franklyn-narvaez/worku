...
export const BasicDataSchema = z.object({
	...
	semester: z.coerce.number<number>().int().min(1, 'El semestre es obligatorio'),
	...
	age: z.coerce.number<number>().int().min(0, 'Edad inválida'),
	...
	dependents: z.coerce.number<number>().int().min(0, 'Debe ser un número mayor o igual a 0'),
	...
	occupationalProfile: z.string().min(1, 'El perfil ocupacional es obligatorio'),
});
