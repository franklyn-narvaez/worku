...
export default function EducationForm() {
	...
	return (
		<div className="mt-8">
			...
			{fields.map((field, index) => {
				...
				return (
					<div key={field.id} className="grid grid-cols-5 gap-4 p-4 border rounded-lg mb-4">
						...
						{/* Ciudad */}
						<FormField name={`educations.${index}.city`} label="Ciudad" type="text" placeholder="Ciudad" />
			...
			{errors.educations?.message && <p className="text-red-500 text-sm mt-2">{errors.educations.message as string}</p>}
